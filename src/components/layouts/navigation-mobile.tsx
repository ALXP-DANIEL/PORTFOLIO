  ...
  return (
    <>
      <motion.div
        ...
        className="site-nav-mobile-brand fixed top-5 left-5 z-200 block lg:hidden"
      >
        <GlassSurface
          className="px-4 py-2"
      ...
      <motion.div
        ...
        transition={{ duration: 0.35, ease: "easeOut" }}
        className="site-nav-mobile fixed bottom-5 left-1/2 z-200 block -translate-x-1/2 lg:hidden"
      >
        <GlassSurface
          as="nav"
